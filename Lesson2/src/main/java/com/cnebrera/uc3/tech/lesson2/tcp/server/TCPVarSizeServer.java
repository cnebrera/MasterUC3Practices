package com.cnebrera.uc3.tech.lesson2.tcp.server;
...
public class TCPVarSizeServer {
     ...
     * @throws IOException          exception thrown if there is an input-output
     *                              problem
    ...
    private static void sendMessagesToClient(final Socket connectionSocket) throws IOException, InterruptedException {
        ...
        // The buffer to write the msg size header, the message size will be an integer
        // (4 bytes)
        ...
        while (true) {
            ...
            // Flip the binary message prior to writing to adjust position to 0 and limit to
